...
Reproit refreshes its internal app model before the audit. Your AI agent gets the
same data through `reproit_accessibility` without a model-management step.
