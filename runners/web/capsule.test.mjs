...
test(
  'capsule replay fulfills exact bootstrap exchange and blocks an ' + 'unmatched request',
  async () => {
          ...
          exchanges: [
            {
              ...
              protocol: 'https',
              method: 'GET',
              url: 'https://app.test/api?a=1&b=2',
              status: 200,
              responseHeaders: { 'content-type': 'application/json' },
              responseBody: { items: [{ author: null }] },
              required: true,
            },
          ],
        }),
