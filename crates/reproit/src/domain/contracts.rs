...
impl FrozenContractGuard {
    ...
    pub(crate) fn reproduces(
        ...
        defects: &[crate::domain::runner::StreamDefect],
    ) -> bool {
    ...
    contracts
        ...
        .map(|contract| {
            ...
            let status = if violations.is_empty() {
                crate::domain::evidence::EvidenceStatus::Satisfied
            } else {
...
"#;
    ...
    fn unscoped_stream_defect_makes_every_contract_abstain() {
        ...
        let defects = [crate::domain::runner::StreamDefect {
            reason: crate::domain::runner::StreamDefectReason::FrameTooLarge,
            scope: crate::domain::runner::EvidenceScope::Contract {
                contract_hash: None,
            },
            sequence: None,
        }];
        ...
        assert!(outcomes.iter().all(|outcome| {
            outcome.status == crate::domain::evidence::EvidenceStatus::Abstain
