...
use super::Capsule;
use crate::model::backend::BackendEventKind;
...
mod tests {
    use super::*;
    use crate::capsule::{Action, Exchange, FindingIdentity};
    use crate::model::backend::{BackendEvent, BackendEventKind};
        ...
        capsule.backend_events = vec![
            ...
            BackendEvent {
                ...
                event: BackendEventKind::Effect {
                    effect: crate::model::backend::EffectKind::Write,
                    resource: None,
                    key: None,
                    tenant: None,
                    event: None,
