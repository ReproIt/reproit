...
use crate::model::appmap::{AppMap, Reversibility};
use crate::model::contracts::{ContractScope, ContractSpec, Eventually, Formula, Predicate};
use anyhow::Result;
use serde::Serialize;
...
mod tests {
    use super::*;
    use crate::model::appmap::{Action, State, StateElement, StateSignature, Transition};
