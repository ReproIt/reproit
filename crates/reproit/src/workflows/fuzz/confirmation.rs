...
async fn capsule_candidate_trial(
    ...
    candidate: &crate::domain::capsule::Capsule,
) -> Result<ReplayTrial> {
...
async fn minimize_environment(
    ...
    sim: bool,
    want: &std::collections::BTreeSet<String>,
    mut capsule: crate::domain::capsule::Capsule,
    json_output: bool,
) -> Result<crate::domain::capsule::Capsule> {
    use crate::domain::capsule::{EnvironmentEnvelope, EnvironmentOutcome, EnvironmentTrial};
