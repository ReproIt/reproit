...
node --test \
  runners/web/backend-transport.test.mjs \
  validation/backend/sdk-node.test.mjs \
  validation/backend/web-e2e.test.mjs \
  validation/backend/cloud-schema-parity.test.mjs
