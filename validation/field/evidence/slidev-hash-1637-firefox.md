# Slidev issue 1637, Firefox review
...
commit. With the single `routerMode: hash` configuration change, three clean Firefox
...
is unavailable through Playwright Firefox and is recorded as such.
