...
Three clean WebKit launches at the affected revision retained `/about` but showed the
...
not expose JavaScript heap measurement for WebKit, so memory is recorded as unavailable
rather than zero.
