...
class SignatureParityTest {
    ...
    fun reduceComputesStructuralSigAndDisplayLabels() {
        ...
        val nodes = listOf(
            ...
            RawNode("", tappable = true),        // clickable + unnamed -> unlabeled
        )
        val tree = screen(
    ...
    fun edgeAndErrorPayloadsMatchContract() {
        ...
        // tap then a state change -> tap:<label> edge
        ...
        val tap = captured[1]
        assertEquals("tap:Open Settings", tap["action"])
