...
public enum ReproItFingerprint {
  ...
  public static func fingerprintValue(_ value: String) -> [String: Any] {
    ...
    func isWs(_ u: UInt16) -> Bool {
      return u == 0x09 || u == 0x0a || u == 0x0b || u == 0x0c || u == 0x0d || u == 0x20 || u == 0xa0
    }
...
public enum ReproItEvent {
  ...
  case error(
    sig: String, path: [ReproItStep], message: String,
    stack: [String], source: String?, line: Int?,
    context: [String: Any]? = nil, t: Int64)
  /// An explicit tester report, verified later by replaying this exact state.
  case testerCapture(
    sig: String, path: [ReproItStep], trigger: String,
    context: [String: Any]? = nil, t: Int64)
  case contractCapture(
    sig: String, path: [ReproItStep], trigger: String,
    identity: String, message: String, t: Int64)
  ...
  public func jsonObject(redactLabels: Bool) -> [String: Any] {
    switch self {
    case .edge(let from, let action, let to, let labels, let t):
      ...
      return obj
    case .error(
      let sig, let path, let message, let stack, let source, let line, let context, let t):
      var obj: [String: Any] = [
        "kind": "error",
      ...
      return obj
    case .testerCapture(let sig, let path, let trigger, let context, let t):
      var obj: [String: Any] = [
        "kind": "error",
      ...
      if let context, !context.isEmpty { obj["context"] = context }
      return obj
    case .contractCapture(let sig, let path, let trigger, let identity, let message, let t):
      return [
        "kind": "error", "oracle": "invariant", "sig": sig,
        "path": path.map {
          var step: [String: Any] = ["sig": $0.sig, "action": $0.action]
          if !redactLabels, let label = $0.label { step["label"] = label }
          return step
        ...
        "message": message,
        "findingIdentity": [
          "oracle": "invariant", "invariant": identity,
          "kind": "structural-contract", "message": message,
          "frame": "", "trigger": trigger, "boundary": sig,
        ],
        "t": t,
      ]
    }
