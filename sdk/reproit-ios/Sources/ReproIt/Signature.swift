...
private func reproitSerializeNode(
  _ n: NormNode, _ depth: Int, _ repeated: Bool, _ tokens: inout [String]
) {
...
private func reproitSerializeChildren(
  _ children: [NormNode], _ depth: Int, _ tokens: inout [String]
) {
  var i = 0
...
public func reproitDescriptorFrom(
  _ anchor: String?, _ root: ReproItNode, _ excludeKeys: Set<String>?
) -> String {
  var tokens: [String] = []
...
public func reproitSelector(id: String?, role: String, structuralIndex: Int) -> ReproItSelector {
  ...
  return ReproItSelector(
    selector: "role:\(reproitNormalizeRole(role))#\(structuralIndex)", nokey: true)
}
