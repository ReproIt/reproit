...
namespace ReproIt.Windows
{
    ...
    internal static class Capture
    {
        ...
        /// <summary>Replay selector for an element: stable id if available,
        /// otherwise a conservative role selector.</summary>
        public static string SelectorOf(object element)
        {
            if (element == null)
            {
                return null;
            ...
            return "role:" + Signature.NormalizeRole(RoleOf(element)) + "#0";
        }
        ...
        /// anything with an automation Invoke/Toggle pattern by class).</summary>
